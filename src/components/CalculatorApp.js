...
//       <div className="w-full max-w-sm md:max-w-md lg:max-w-lg bg-zinc-900 rounded-lg overflow-hidden shadow-2xl">
//         {/* Header */}
...
//             </span>
//           </div>
//           <button className="text-white hover:bg-zinc-800 p-1.5 md:p-2 rounded">
//             <svg
...
//           <div className="text-gray-300 text-base md:text-xl lg:text-2xl font-light overflow-hidden overflow-ellipsis">
//             {inputString}
//           </div>
//         </div>
//         <div className="px-4 pb-4 pt-1 md:px-6 md:pb-6 md:pt-1 text-right">
//           <div className="text-white text-3xl md:text-5xl lg:text-6xl font-light overflow-hidden overflow-ellipsis">
//             {display}
//           </div>
//         </div>
//         {/* Memory Buttons */}
